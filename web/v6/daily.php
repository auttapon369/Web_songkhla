...
<div class="paper shadow center">
	...
	<br>
	<img src="<?php echo $_cfg_path['img'] ?>pic_map.jpg">
</div>
...
<link href="<?php echo $_cfg_path['script'] ?>timepicker/jquery-ui-timepicker-addon.css" rel="stylesheet" type="text/css">
<link href="<?php echo $_cfg_path['script'] ?>timepicker/jquery-ui.css" rel="stylesheet" type="text/css">
<script src="<?php echo $_cfg_path['script'] ?>timepicker/jquery-ui.js"></script>
<script src="<?php echo $_cfg_path['script'] ?>timepicker/jquery-ui-timepicker-addon.js"></script>
<script src="<?php echo $_cfg_path['script'] ?>timepicker/jquery-ui-timepicker-th.js"></script>
