...
//			var dr = Number(markers[i].getAttribute("dr"));
			...
			// alarm wl
			var wl_alarm;
			if(wl_val > wl_lv2){wl_alarm ='<button type="button" class="btn btn-danger">เตือนภัยHH</button>';}
			else if(wl_val > wl_lv1){wl_alarm ='<button type="button" class="btn btn-warning">เฝ้าระวังH</button>';}
			else if(wl_val < wl_lv00){wl_alarm ='<button type="button" class="btn btn-danger">เตือนภัยLL</button>';}
			else if(wl_val < wl_lv0){wl_alarm ='<button type="button" class="btn btn-warning">เฝ้าระวังL</button>';}
			else{wl_alarm ='<button type="button" class="btn btn-success">ปกติ</button>';}


			var rf_alarm;
			if(rf_77 > rf_lv2){rf_alarm ='<button type="button" class="btn btn-danger">เตือนภัยHH</button>';}
			else if(rf_77 > rf_lv1){rf_alarm ='<button type="button" class="btn btn-warning">เฝ้าระวังH</button>';}
...
//			var p_lv2 = ( wl == 1 ) ? '<TR><TD CLASS="left">ระดับเตือนภัย</TD><TD CLASS="right">'+wl_lv2+'</TD><TD CLASS="left">ม.รทก.</TD></TR>' : '';
			...
			var L5  = '<TR><TD CLASS="left">น้ำฝนสะสม 48 ชม. </TD><TD CLASS="right">'+rf_48+' มม.</TD><TD CLASS="left">ระดับเฝ้าระวังL </TD><TD CLASS="right">'+wl_lv0+' ม.รทก.</TD></TR>';
			var L6  = '<TR><TD CLASS="left">น้ำฝนสะสม 72 ชม </TD><TD CLASS="right">'+rf_72+' มม.</TD><TD CLASS="left">ระดับเตือนภัยLL </TD><TD CLASS="right">'+wl_lv00+' ม.รทก.</TD></TR>';
			var L7  = '<TR><TD CLASS="left"></TD><TD CLASS="right"></TD><TD CLASS="left">ระดับเฝ้าระวังH </TD><TD CLASS="right">'+wl_lv1+' ม.รทก.</TD></TR>';
			var L8  = '<TR><TD CLASS="left"></TD><TD CLASS="right"></TD><TD CLASS="left">ระดับเตือนภัยHH </TD><TD CLASS="right">'+wl_lv2+' ม.รทก.</TD></TR>';
			...
			html = '<DIV CLASS="popup">'
						...
						+'<TABLE>'
						//+ p_rf1 + p_rf77 + p_rf24 + p_rf48 + p_rf72 + p_wl + p_left + p_right + p_lv1 + p_lv2
