...
//			var dr = Number(markers[i].getAttribute("dr"));
			...
			// alarm wl
			var wl_alarm;
			if(wl_val > wl_lv2){wl_alarm ='<button type="button" class="btn btn-danger">วิกฤตน้ำท่วม</button>';}
			else if(wl_val > wl_lv1){wl_alarm ='<button type="button" class="btn btn-warning">เฝ้าระวังน้ำท่วม</button>';}
			else if(wl_val < wl_lv00){wl_alarm ='<button type="button" class="btn btn-danger">วิกฤตน้ำแล้ง</button>';}
			else if(wl_val < wl_lv0){wl_alarm ='<button type="button" class="btn btn-warning">เฝ้าระวังน้ำแล้ง</button>';}
			else{wl_alarm ='<button type="button" class="btn btn-success">ปกติ</button>';}


			var rf_alarm;
			if(rf_77 > rf_lv2){rf_alarm ='<button type="button" class="btn btn-danger">วิกฤตภัยฝน</button>';}
			else if(rf_77 > rf_lv1){rf_alarm ='<button type="button" class="btn btn-warning">เฝ้าระวังฝน</button>';}
			else{rf_alarm ='<button type="button" class="btn btn-success">ปกติ</button>';}
			...
			var mss;
			if((wl_val - tr) > 0){mss ="สูงกว่าตลิ่ง";}else{mss ="ต่ำกว่าตลิ่ง";}
...
//			var p_lv2 = ( wl == 1 ) ? '<TR><TD CLASS="left">ระดับเตือนภัย</TD><TD CLASS="right">'+wl_lv2+'</TD><TD CLASS="left">ม.รทก.</TD></TR>' : '';
			...
			if(wl==1){
			var L1  = '<TR><TD COLSPAN="2" CLASS="left">ปริมาณฝน :  '+rf_alarm+'</TD><TD COLSPAN="2" CLASS="left">ระดับน้ำ :  '+wl_alarm+'</TD></TR>';
			var L2  = '<TR><TD CLASS="left">ฝนวันนี้ </TD><TD CLASS="right">'+rf_77+' มม.</TD><TD CLASS="left">ระดับน้ำ </TD><TD CLASS="right">'+wl_val+' ม.รทก.</TD></TR>';
			var L3  = '<TR><TD CLASS="left">ฝนรายชั่วโมง</TD><TD CLASS="right">'+rf_1+' มม.</TD><TD CLASS="left">ระดับตลิ่งซ้าย </TD><TD CLASS="right">'+wl_left+' ม.รทก.</TD></TR>';
			var L4  =  '<TR><TD CLASS="left">น้ำฝนสะสม 24 ชม. </TD><TD CLASS="right">'+rf_24+' มม.</TD><TD CLASS="left">ระดับตลิ่งขวา </TD><TD CLASS="right">'+wl_right+' ม.รทก.</TD></TR>';
			var L4A  = '<TR><TD CLASS="left"></TD><TD CLASS="right"></TD><TD CLASS="left">ระดับน้ำ'+mss+' </TD><TD CLASS="right">'+Math.abs(wl_val - tr).toFixed(2)+' ม.____.</TD></TR>';
			var L5  = '<TR><TD CLASS="left"></TD><TD CLASS="right"></TD><TD CLASS="left">เฝ้าระวังน้ำแล้ง </TD><TD CLASS="right">'+wl_lv0+' ม.รทก.</TD></TR>';
			var L6  = '<TR><TD CLASS="left"></TD><TD CLASS="right"></TD><TD CLASS="left">วิกฤตน้ำแล้ง </TD><TD CLASS="right">'+wl_lv00+' ม.รทก.</TD></TR>';
			var L7  = '<TR><TD CLASS="left"></TD><TD CLASS="right"></TD><TD CLASS="left">เฝ้าระวังน้ำท่วม </TD><TD CLASS="right">'+wl_lv1+' ม.รทก.</TD></TR>';
			var L8  = '<TR><TD CLASS="left"></TD><TD CLASS="right"></TD><TD CLASS="left">วิกฤตน้ำท่วม </TD><TD CLASS="right">'+wl_lv2+' ม.รทก.</TD></TR>';
			
			}
			else
			{
				var L1  = '<TR><TD COLSPAN="2" CLASS="left">ปริมาณฝน :  '+rf_alarm+'</TD><TD COLSPAN="2" CLASS="left"></TD></TR>';
			var L2  = '<TR><TD CLASS="left">ฝนวันนี้ </TD><TD CLASS="right">'+rf_77+' มม.</TD><TD CLASS="left"> </TD><TD CLASS="right"></TD></TR>';
			var L3  = '<TR><TD CLASS="left">ฝนรายชั่วโมง</TD><TD CLASS="right">'+rf_1+' มม.</TD><TD CLASS="left"> </TD><TD CLASS="right"></TD></TR>';
			var L4  =  '<TR><TD CLASS="left">น้ำฝนสะสม 24 ชม. </TD><TD CLASS="right">'+rf_24+' มม.</TD><TD CLASS="left"> </TD><TD CLASS="right"></TD></TR>';
			...
			html = '<DIV CLASS="popup">'
						...
						+'</TABLE><br>'
						+'<button type="button" class="btn btn-success"><A HREF="./?page=station&id='+id+'"><i class="glyphicon glyphicon-list-alt"></i> รายละเอียด</A></button>'
					+'</DIV>';
