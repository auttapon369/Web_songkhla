	...
	(
		...
		{ 
			...
			{ 
				...
				$clonedTable.attr("id", "fixedtableheader" + i).css({ "position": "fixed", "top": "0px", "left": $tbl.offset().left }).append($tblhfixed.clone()).width(tblwidth).hide().appendTo($("body"));
				$(window).scroll
				(
					function()
					{
						if (jQuery.browser.msie && jQuery.browser.version == "6.0")
							...
							$clonedTable.css({ "position": "fixed", "top": "0px", "left": $tbl.offset().left - $(window).scrollLeft() });
